...
c4011::c4011(const std::string &value)
{
    ...
    this->_pin[2] = new nts::pin_t(&GateNAND, nts::OUTPUT, nullptr, std::vector<int> {0, 1});
    this->_pin[3] = new nts::pin_t(&GateNAND, nts::OUTPUT, nullptr, std::vector<int> {4, 5});
    ...
    this->_pin[9] = new nts::pin_t(&GateNAND, nts::OUTPUT, nullptr, std::vector<int> {7, 8});
    this->_pin[10] = new nts::pin_t(&GateNAND, nts::OUTPUT, nullptr, std::vector<int> {11, 12});
