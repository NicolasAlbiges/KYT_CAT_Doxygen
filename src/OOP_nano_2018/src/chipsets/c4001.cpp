...
c4001::c4001(const std::string &value): AComponent::AComponent()
{
    _value = value;
    _type = "c4001";
    _nbOfPin = 14;
    ...
    this->_pin[2] = new nts::pin_t(&GateNOR, nts::OUTPUT, nullptr, std::vector<int> {0, 1});
    ...
    this->_pin[3] = new nts::pin_t(&GateNOR, nts::OUTPUT, nullptr, std::vector<int> {4, 5});
    ...
    this->_pin[9] = new nts::pin_t(&GateNOR, nts::OUTPUT, nullptr, std::vector<int> {7, 8});
    ...
    this->_pin[10] = new nts::pin_t(&GateNOR, nts::OUTPUT, nullptr, std::vector<int> {11, 12});
